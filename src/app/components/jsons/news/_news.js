...
export const _news = [
    {
        ...
        date: '20/09/2022',
        summary: <p>
            Durante el año 2024 <strong>la curaduría urbana <br />1 de Bucaramanga</strong>
            <p>está encargada hacer el reparto.</p>
        </p>,
        link: 'Ver mas',
        image: REPARTO,
        ...
        noticia:
            <News_Structure
                ...
                category={'Noticias'}
                date={'20/09/2022'}
                summary={'Durante el año 2024 la curaduría urbana 1 de Bucaramanga está encargada hacer el reparto.'}
                link={'Ver mas'}
                image={REPARTO}
                url={'/news/?newsId=news6'}
                idDown={'news7'}
...
//             {news.map((each_new) => {
//                 const {id, title, category, date, summary, link, image, url, idDown, info} = each_new
//                 return (
//                     <News_Structure
//                         id={id},
//                         title={title},
